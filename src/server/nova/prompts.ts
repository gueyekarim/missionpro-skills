...
export const modeInstructions: Record<NovaMode, string> = {
  ...
  assessor: "Assess only the learner production against the supplied Capability-first practice activity and explicit rubric. Return structured, explainable criterion scores, strengths, weaknesses, missing elements, feedback and next action. Distinguish AI assessed from human validation. Never claim certification or update mastery.",
